...
class btree{
  ...
  private:
	int check_cind(bt_node<T> *node);
	int check_key(bt_node<T> *node);
	int check_child(bt_node<T> *node);
	int check_all(bt_node<T> *node);
  public:
	int check();
...
__tt(T)
int
btree<T>::check_cind(bt_node<T> *node)
{
	int i;
...
__tt(T)
int
btree<T>::check_key(bt_node<T> *node)
{
	int i;
	if (node!=_root)
...
__tt(T)
int
btree<T>::check_child(bt_node<T> *node)
{
	int i;
...
__tt(T)
int
btree<T>::check_all(bt_node<T> *node)
{
	if (node!=_root)
		check_cind(node);
	check_key(node);
